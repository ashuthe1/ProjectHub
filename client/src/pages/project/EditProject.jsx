...
const EditProject = () => {
  ...
  const addTechStack = () => {
    ...
    const newTechStack = [...formDetails.techStack, techStack];
    updatedFormDetails.techStack = newTechStack;
  ...
  const addLongDescription = () => {
    ...
    const updatedFormDetails = { ...formDetails };
    const newLongDescription = [...formDetails.longDescription, longDescription];
    updatedFormDetails.longDescription = newLongDescription;
    setFormDetails(updatedFormDetails);
    setLongDescription("");
  };
  ...
  return (
    <section className="box flex flex-col gap-6">
      <h2 className="font-bold text-xl">Edit Your Project</h2>
      <hr />
      {rest.isLoading ? (
        <ComponentLoading />
      ) : (
