  ...
  return (
    <>
      {isLoading ? (
        ...
        <AllCards
          mainTitle={"Your ProjectHub Chronicles"}
          tagline={
            "Dive into a world of your engaging articles and captivating stories on ProjectHub Chronicles."
          }
          type={"blog"}
          data={updatedData}
        />
