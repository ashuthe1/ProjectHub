  ...
  return (
    <section className="box flex flex-col gap-10 mt-28 items-center">
      <div className="flex flex-col gap-2 items-center">
        ...
        Empower Your Journey: Select Your Plan, Embrace Success with Limitless Possibilities!
        </p>
      </div>
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-12 w-full md:w-[80%] lg:w-[50%]">
        <SubscribeCard
          ...
          features={["Access to projects", "Access to blogs",  "Add your project", "Save projects"]}
